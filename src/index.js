...
const addRock = document.querySelector("#Rock");
const addPaper = document.querySelector("#Paper");
const addScissors = document.querySelector("#Scissors");
const voorspel = document.querySelector("#voorspel");
const train = document.querySelector("#train");

addRock.addEventListener("click", () => leerRock());
addPaper.addEventListener("click", () => leerPaper());
addScissors.addEventListener("click", () => leerScissors());
voorspel.addEventListener("click", () => predict() && console.log("predicting"));
